...
<head>
	...
	<title>T3DK | Quản Lý Pages</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Quản Lý Pages </h2>
                  ...
                  <option value="manage-pages.php?type=terms">Các Điều Khoản Và Điều Kiện</option>
                  <option value="manage-pages.php?type=privacy">Chính Sách Và Quyền Riêng Tư</option>
			...
			?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn">Sửa Đổi</button>
												</div>
											</div>
