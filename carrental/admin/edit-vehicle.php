...
<head>
	...
	<title>T3DK | Thay Đổi Xe Chi Tiết</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Thay Đổi Xe Chi Tiết</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">Giá Thuê Xe 1 Ngày (VND)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Loại Nhiên Liệu<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Mẫu Xe Năm<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Sửa Ảnh 4</a>
</div>
<div class="col-sm-4">
Ảnh 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Sửa Ảnh 5</a>
<?php } ?>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Trang Bị Của Xe</div>
<div class="panel-body">
...
<label for="inlineCheckbox1"> Điều Hoà </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Khoá Cửa Điện </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Hệ Thống Phanh ABS </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Trợ Lực Tay Lái </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Túi Khí Ghế Tài Xế</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Túi Khí Ghế Hành Khách </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Cửa Sổ Trời </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerwindow" value="1">
<label for="inlineCheckbox3"> Cửa Số Trời </label>
</div>
<?php } ?>
</div>
...
<label for="inlineCheckbox1"> Đầu CD </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Khoá Trung Tâm</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
